...
namespace dotnet_rpg.Services.FightService
{
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<List<HighsocreDto>>> GetHighScore()
        {
            var characters = await _context.Characters
                .Where(c => c.Fights > 0)
            ...
            var response = new ServiceResponse<List<HighsocreDto>>{
                Data = characters.Select(c => _mapper.Map<HighsocreDto>(c)).ToList()
            };
            return response;
        }
    }
